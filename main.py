...
async def txt_handler(bot: Client, m: Message):  
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            elif 'media-cdn.classplusapp.com' in url or 'videos.classplusapp' in url or 'tencdn.classplusapp' in url or 'media-cdn-alisg.classplusapp.com' in url or 'media-cdn-a.classplusapp.com' in url:
